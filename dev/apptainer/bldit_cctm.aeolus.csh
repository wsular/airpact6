...
# Usage: bldit_cctm.csh pgi | & tee bldit_cctm_cb6r3_ae6_aq.log 
# Usage: bldit_cctm.csh pgi | & tee bldit_cctm_saprc07tb_ae6_aq.log 
#
...
# set Bld = $CMAQ_HOME/CCTM/scripts/BLD_CCTM_${VRSN}_${compiler}
  ...
  # set APPL     = saprc07tb_ae6_aq #cb6r3_ae6_aq  #saprc07tb_ae6_aq #cb05tucl_ae6_aq #saprc07tb_ae6_aq #cb6r3_ae6_aq  #cb05tucl_ae6_aq
   set APPL     = saprc07tb_ae6_aq
  
   set EXEC     = CCTM_${APPL}_$EXEC_ID
   set CFG     = cfg.CCTM_${APPL}_$EXEC_ID
   set Bld = $CMAQ_HOME/CCTM/scripts/BLD_CCTM_${APPL}
...
#>   may also refer to the CMAQ documentation.
 ...
 set Mechanism = ${APPL}   #cb6r3_ae6_aq        #> chemical mechanism (see $CMAQ_MODEL/CCTM/src/MECHS)
