...
- The [Community Multiscale Air Quality (CMAQ) model](https://github.com/USEPA/CMAQ.git) is a suite of programs for simulating air quality. This model forms the basis of AIRPACT6.
  - The script below was adapted from [here](https://github.com/USEPA/CMAQ/blob/main/DOCS/Users_Guide/Tutorials/gcc_install_cmaq55_cb6r5_m3dry.csh)
