'''
netCDF Wrapper Library for Gridded I/O API-like files

By James Beidler

Copied from https://forum.cmascenter.org/t/netcdf-wrapper-library-for-gridded-i-o-api-like-files/2778 on 9 November 2021 21:35 PST.
'''
import numpy as np
