...
# Farren 2022-8-17 - adapting this to work for Canada locations; assuming a constant FCCS code of 52
...
counties = geopandas.read_file("counties.shp")
locations_temp = pandas.read_csv("fire_locations.csv")
...
joined.to_csv(r'fire_locations_fips.csv')
...
#Create the kml file.
kmlf = open('fire_locations.kml', 'w')
...
locations_list = open('fire_locations_fips.csv', 'r')
