...
#      4 Jan 2023  Added support for processing different forecast days (V.P. Walden)
#=======================================================================
...
if ( $#argv >= 1 ) then
   ...
   setenv SRTHR "00"
   setenv FCSTHR `echo $2 | cut -c9-10`
else
...
# AIRPACT locations
set HOME      = /home/airpact
set AIRRUN    = $HOME/AIRRUN
set AIRHOME   = $HOME/AIRHOME 
set AIRDATA   = $AIRRUN
set InMetDir  = $AIRRUN/input/UW_WRF
set InTerDir  = $AIRRUN/input/domain 
set OutDir    = $AIRRUN/output/$1/$2
set ProgDir   = /opt/CMAQv5.3.2/PREP/mcip/src
set WorkDir   = $OutDir

#setenv AIRTOOL /opt/ioapi-3.2/Linux2_x86_64ifort
setenv RUNROOT $OutDir
if ( ! -d $RUNROOT ) then
