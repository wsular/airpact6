...
#
  ...
  if ( ! $?basedir  )  set basedir  = ~airpact/airpact6/AIRHOME/run_ap5_day1
  cd $basedir
...
# some prerequesites
  if ( ! $?airroot       ) setenv airroot       /mnt/disk2/airpact/airpact5/AIRRUN
  if ( ! $?airrun        ) setenv airrun        $airroot/$thisyear
#  if ( ! $?airrootday2 ) setenv airrootday2   /data/lar/projects/airpact5/AIRRUNDAY2
  if ( ! $?mciproot      ) setenv mciproot      $airroot/$thisyear
  if ( ! $?bconroot      ) setenv bconroot      $airroot/$thisyear
  set logdir = $airrun/${currentday}00/LOGS

# add m3tools directory to path
setenv PATH ${PATH}:/home/airpact/airpact6/CMAQv5.5/LIBRARIES/ioapi-3.2/Linux2_x86_64gfort
...
/home/airpact/airpact6/AIRHOME/cctm/run_cctm_airpact5.csh $currentday
