...
setenv PATH /home/airpact/airpact6/CMAQv5.5/LIBRARIES/ioapi-3.2/Linux2_x86_64gfort:${PATH}
source ../AIRPACT6_env_vars.csh
...
#> program location ----------------------------------------------------
   set EXEC_ID  = Linux2_x86_64gfort
   set APPL     = cb6r5_ae7_aq_m3dry_debug
   set CFG      = Linux2_x86_64gfort
   set MECH     = cb6r5_ae7_aq
   set EXEC     = CCTM_v55_gcc_${APPL}
   set PROGDIR     = ~airpact/airpact6/CMAQv5.5/openmpi_gcc/CCTM/scripts
   set BLD      = ${PROGDIR}/BLD_${EXEC}
...
#> input and output directories and files ------------------------------
    ...
    set AIROUT = /mnt/disk2/airpact/airpact5/AIRRUN/2024/2024102200
    set AIRROOT = $AIROUT
    set BCONDIR = $AIROUT/BCON
   ...
   #> input files and directories
      set OCEANpath = /home/airpact/airpact6/AIRHOME/domain
     ...
     #set TR_EMfile = $EMISfile # 
      ...
      set GC_ICpath = $AIROUT/${previousdayyear}/${previousday}00/CCTM
...
#    mpirun  $BLD/$EXEC
#( /usr/bin/time -p mpirun -np $NPROCS --use-hwthread-cpus $BLD/CCTM_v55.exe ) |& tee buff_${EXECUTION_ID}.txt
$BLD/CCTM_v55.exe |& tee buff_${EXECUTION_ID}.txt
